  ...
  return (
    <footer className="border-t border-[var(--border)] mt-20">
      <div className="max-w-7xl mx-auto py-10 px-6 text-center">
        ...
        <p className="mt-3 text-[var(--muted)]">Software Engineering Student</p>
        ...
        <div className="flex justify-center gap-6 mt-6">
          ...
          <a
            href="https://www.linkedin.com/in/ahmed-ben-said-83844225b/"
            target="_blank"
            rel="noreferrer"
          >
            <Linkedin />
        ...
        <p className="text-sm mt-8 text-[var(--muted)]">
